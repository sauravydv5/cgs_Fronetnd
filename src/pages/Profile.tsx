  ...
  useEffect(() => {
    const fetchAndSetProfile = async () => {
      ...
      const populateForm = (profileData) => {
        if (!profileData) {
          console.error("Attempted to populate form with null profile data.");
          return;
        }
      ...
      try {
        ...
        if (response.status) {
          const profileData = response.data; // Assuming response.data holds the profile object
          if (profileData) {
          ...
          <div className="mx-auto max-w-2xl rounded-lg bg-white p-6 shadow-sm">
            ...
            <div className="flex justify-center mb-8">
              <div className="relative">
                <div
                  className="w-28 h-28 rounded-full bg-[#F1D5CF] text-[#E98C81] 
...
shadow-sm text-center text-4xl font-semibold leading-none"
                ...
                <label
                  ...
                  className="absolute bottom-0 right-0 w-8 h-8 bg-[#EE9E92] rounded-full flex items-center justify-center hover:bg-[#F1D5CF] transition-colors cursor-pointer"
                >
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  disabled={saving}
                  className="w-full px-4 py-2 bg-[#E98C81] text-white rounded-lg hover:bg-[#863f37] transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
                >
